...
public class PointerTracker<T : Component<T, C>, C : ComponentProperties<T, C>> {
    ...
    internal fun handlePointerClick(x: Double, y: Double, button: MouseButton) {
        ...
        currentClickCount = if (System.currentTimeMillis() - lastClickedTime < 500) currentClickCount + 1 else 1
