...
class MinConstraint(
    ...
    override fun getImplValueForX(component: BaseComponent): Float {
        ...
        return min(firstX.getValueForX(component), secondX.getValueForX(component))
    }
    ...
    override fun getImplValueForY(component: BaseComponent): Float {
        ...
        return min(firstY.getValueForY(component), secondY.getValueForY(component))
    }
    ...
    override fun getImplValueForWidth(component: BaseComponent): Float {
        ...
        return min(firstWidth.getValueForWidth(component), secondWidth.getValueForWidth(component))
    }
    ...
    override fun getImplValueForHeight(component: BaseComponent): Float {
        ...
        return min(firstHeight.getValueForHeight(component), secondHeight.getValueForHeight(component))
    }
    ...
    override fun getImplValueForRadius(component: BaseComponent): Float {
        ...
        return min(firstRadius.getValueForRadius(component), secondRadius.getValueForRadius(component))
    }
}
